...
export const Courses = () => {
  ...
  const handleSaveCategory = () => {
    ...
    if (editingCategory) {
      ...
      setCategories(prev => [...prev, { ...categoryForm, id: categoryId }]);
  ...
  const handleSaveLevel = () => {
    ...
    if (editingLevel) {
      ...
      setLevels(prev => [...prev, { ...levelForm, id: levelId }]);
                          ...
                          <div className="space-y-1">
                            <div className="flex items-center gap-2">
                              <span className="text-2xl font-bold text-gray-900">
                                {course.price === 0 ? 'Free' : course.price > 0 ? `₹${course.price}` : '-'}
                              </span>
